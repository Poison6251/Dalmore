    ...
    public class ModalThrowable : Throwable
    {
        ...
        protected override void HandHoverUpdate(Hand hand)
        {
            ...
            if (startingGrabType != GrabTypes.None)
            {
                ...
                {
                    hand.AttachObject(gameObject, startingGrabType,null, attachmentFlags, pinchOffset);
                }
                else if (startingGrabType == GrabTypes.Grip)
                {
                    hand.AttachObject(gameObject, startingGrabType,null, attachmentFlags, gripOffset);
                }
                else
                {
                    hand.AttachObject(gameObject, startingGrabType, null, attachmentFlags, attachmentOffset);
                }
