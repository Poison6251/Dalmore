...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        //-------------------------------------------------
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, Transform parent = null, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            // Add
            ...
            attachedObject.handAttachmentPointTransform = parent;
            ...
            if (attachedObject.HasAttachFlag(AttachmentFlags.ParentToHand))
            {
                ...
                objectToAttach.transform.parent = parent;
            ...
            if (attachedObject.HasAttachFlag(AttachmentFlags.SnapOnAttach))
            {
                if (attachedObject.interactable != null && attachedObject.interactable.skeletonPoser != null && HasSkeleton())
                {
                    ...
                    objectToAttach.transform.position = parent.TransformPoint(pose.position);
                    objectToAttach.transform.rotation = parent.rotation * pose.rotation;
        ...
        protected virtual void OnInputFocus(bool hasFocus)
        {
            ...
            else
            {
                ...
                AttachObject(applicationLostFocusObject, GrabTypes.Scripted, null,AttachmentFlags.ParentToHand);
